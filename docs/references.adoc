...
* **NATO**
 * https://nso.nato.int/nso/nsdd/stanagdetails.html?idCover=8285&LA=EN[STANAG 4603 Ed 2] - [IEEE 1516-2010 - High Level Architecture (HLA)](https://standards.ieee.org/findstds/standard/1516-2010.html)
